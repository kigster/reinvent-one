...
export const clients: Client[] = [
  {
    name: 'CFAEA (503c) Organization',
    subtitle: 'Ticketing Site',
    details:
      'Upgraded in 2025-2026 a hopelessly out of date and dysfunctional Rails v4 application, which was highly insecure and vulnerable due to its age and the lack of security maintenance. Upgrade the application to Rails 8.1.2, Ruby 4.0.2, Replaced Bootstrap with Tailwind CSS, updated all the styles, turned on Solid Cache, and effectively revived the site that was dying due to lack of maintenance. In the process increased test coverage from 0% to 70%. Upgrades allowed the organization to properly launch their summer events because  previously broken site was finally working.',
    externalUrl: 'https://tickets.fnf.events/',
    image: '/images/clients/fnf.jpg',
    short: 'CFAEA (503c) Organization'
  },
  {
